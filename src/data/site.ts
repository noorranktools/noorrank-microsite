// Single source of truth for site content. Pulled from NoorRank_Profile_2026.
...
export const founders = [
  ...
  },
  {
    name: "Devika",
    role: "CTO & Co-Founder",
    bio: "Leads every system NoorRank ships and built the in-house tools the company runs on. If NoorRank delivers a platform, it came from her.",
  },
];
...
export const miracleBerry = {
  title: "The Miracle Berry Protocol",
  ...
  lessons: [
    { n: "01", title: "AI recognition is not linear", body: "Expect a volatility phase before permanent stability." },
    { n: "02", title: "Each platform has its own timeline", body: "ChatGPT: 9 days. Perplexity: 17 days. One strategy won't fit all." },
    { n: "03", title: "Structured data is the skeleton key", body: "Schema.org + persistent @id = indexed Day 1, cited Day 9." },
  ],
};
